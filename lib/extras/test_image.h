...
#ifndef PDFCORE_LIB_EXTRAS_TEST_IMAGE_H_
#define PDFCORE_LIB_EXTRAS_TEST_IMAGE_H_
...
class TestImage {
 public:
  ...
  TestImage& SetDataType(PdfcoreDataType data_type);

  TestImage& SetEndianness(PdfcoreEndianness endianness);
 ...
 private:
  ...
  PdfcorePixelFormat format_ = {3, PDFCORE_TYPE_UINT8, PDFCORE_LITTLE_ENDIAN, 0};

  static void CropLayerInfo(size_t xsize, size_t ysize, PdfcoreLayerInfo* info);

  static void CropImage(size_t xsize, size_t ysize, extras::PackedImage* image);

  static PdfcoreDataType DefaultDataType(const PdfcoreBasicInfo& info);
};

}  // namespace test
}  // namespace pdfcore

#endif  // PDFCORE_LIB_EXTRAS_TEST_IMAGE_H_
