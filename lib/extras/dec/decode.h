...
#ifndef PDFCORE_LIB_EXTRAS_DEC_DECODE_H_
#define PDFCORE_LIB_EXTRAS_DEC_DECODE_H_
...
Codec CodecFromPath(const std::string& path,
                    size_t* PDFCORE_RESTRICT bits_per_sample = nullptr,
...
Status DecodeBytes(Span<const uint8_t> bytes, const ColorHints& color_hints,
                   ...
                   PdfcoreMemoryManager* memory_manager = nullptr,
                   bool coalescing = true);

}  // namespace extras
}  // namespace pdfcore

#endif  // PDFCORE_LIB_EXTRAS_DEC_DECODE_H_
