...
#if defined(PDFCORE_LIB_EXTRAS_CONVOLVE_INL_H_) == defined(HWY_TARGET_TOGGLE)
#ifdef PDFCORE_LIB_EXTRAS_CONVOLVE_INL_H_
#undef PDFCORE_LIB_EXTRAS_CONVOLVE_INL_H_
#else
#define PDFCORE_LIB_EXTRAS_CONVOLVE_INL_H_
#endif
...
#elif HWY_TARGET == HWY_SCALAR
    const D d;
    PDFCORE_DEBUG_ABORT("Unsupported");
    return Zero(d);
#else  // 128 bit
    // c = LKJI
#if HWY_TARGET <= (1 << HWY_HIGHEST_TARGET_BIT_X86)
...
#endif  // PDFCORE_LIB_EXTRAS_CONVOLVE_INL_H_
