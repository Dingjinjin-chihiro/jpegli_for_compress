...
#ifndef PDFCORE_LIB_BASE_MATRIX_OPS_H_
#define PDFCORE_LIB_BASE_MATRIX_OPS_H_
...
Status Inv3x3Matrix(Matrix& matrix) {
  ...
  if (std::abs(det) < 1e-10) {
    return PDFCORE_FAILURE("Matrix determinant is too close to 0");
  }
  double idet = 1.0 / det;
...
#endif  // PDFCORE_LIB_BASE_MATRIX_OPS_H_
