...
// jpeg_* to pdfcore_jpegli_*, while compressor object definitions are included directly
// from jpeglib.h
//
...
#ifndef PDFCORE_LIB_PDFCORE_ENCODE_H_
#define PDFCORE_LIB_PDFCORE_ENCODE_H_
...
#define pdfcore_jpegli_create_compress(cinfo)              \
  pdfcore_jpegli_CreateCompress((cinfo), JPEG_LIB_VERSION, \
...
// it must be called after pdfcore_jpegli_set_defaults() or after the last
// pdfcore_jpegli_set_colorspace() or pdfcore_jpegli_default_colorspace() calls.
...
// matrices and chroma subsampling. Must be called before pdfcore_jpegli_set_defaults()
...
// through pdfcore_jpegli_write_scanlines() has this transfer function. This must be
// called before pdfcore_jpegli_set_defaults() because it changes the default
// quantization tables.
...
// AC coefficients. Must be called before pdfcore_jpegli_set_defaults().
...
#endif  // PDFCORE_LIB_PDFCORE_ENCODE_H_
