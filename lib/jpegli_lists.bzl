...
libpdfcore_jpegli_base_sources = [
    "base/bits.h",
    "base/byte_order.h",
...
libpdfcore_jpegli_codec_apng_sources = [
    "extras/dec/apng.h",
    "extras/enc/apng.h",
]

libpdfcore_jpegli_codec_exr_sources = [
    "extras/dec/exr.cc",
    "extras/dec/exr.h",
    "extras/enc/exr.cc",
    "extras/enc/exr.h",
...
libpdfcore_jpegli_codec_gif_sources = [
    "extras/dec/gif.cc",
    "extras/dec/gif.h",
]

libpdfcore_jpegli_codec_pdfcore_jpegli_sources = [
...
libpdfcore_jpegli_codec_jpg_sources = [
    "extras/dec/jpg.cc",
    "extras/dec/jpg.h",
    "extras/enc/jpg.cc",
    "extras/enc/jpg.h",
...
libpdfcore_jpegli_codec_npy_sources = [
    "extras/enc/npy.cc",
    "extras/enc/npy.h",
]

libpdfcore_jpegli_codec_pgx_sources = [
    "extras/dec/pgx.cc",
    "extras/dec/pgx.h",
    "extras/enc/pgx.cc",
    "extras/enc/pgx.h",
...
libpdfcore_jpegli_codec_pnm_sources = [
    "extras/dec/pnm.cc",
    "extras/dec/pnm.h",
    "extras/enc/pnm.cc",
    "extras/enc/pnm.h",
...
libpdfcore_jpegli_extras_for_tools_sources = [
    "extras/metrics.cc",
    "extras/metrics.h",
...
libpdfcore_jpegli_extras_sources = [
...
libpdfcore_jpegli_pdfcore_jpegli_lib_version = 62

libpdfcore_jpegli_pdfcore_jpegli_libjpeg_helper_files = [
    "jpegli/libjpeg_test_util.cc",
    "jpegli/libjpeg_test_util.h",
]

libpdfcore_jpegli_pdfcore_jpegli_sources = [
...
libpdfcore_jpegli_pdfcore_jpegli_testlib_files = [
    "jpegli/fuzztest.h",
...
libpdfcore_jpegli_pdfcore_jpegli_tests = [
...
libpdfcore_jpegli_pdfcore_jpegli_wrapper_sources = [
    "jpegli/libjpeg_wrapper.cc",
]

libpdfcore_jpegli_major_version = 0

libpdfcore_jpegli_minor_version = 12

libpdfcore_jpegli_patch_version = 0

libpdfcore_jpegli_testlib_files = [
...
libpdfcore_jpegli_threads_sources = [
